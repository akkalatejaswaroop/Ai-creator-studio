...
import { AiToolComponentProps, EmailWriterToolProps } from '../../types';
...
const EmailWriterTool: React.FC<AiToolComponentProps> = ({ tool, language, onGenerationComplete }) => {
