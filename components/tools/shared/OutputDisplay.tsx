...
export const OutputDisplay: React.FC<OutputDisplayProps> = ({ isLoading, error, content, defaultText, tool }) => {
    ...
    return (
        <div className="w-full h-full flex-grow bg-black/30 border border-white/10 rounded-lg p-4 overflow-y-auto relative text-sm group">
            ...
            <div ref={outputRef} className="markdown-body pt-8" aria-live="polite"></div>
