...
import { AiToolComponentProps, ToneChangerToolProps } from '../../types';
import { Loader } from '../Loader';
import { Select } from './shared/Select';
import { OutputDisplay } from './shared/OutputDisplay';
import { streamTextGeneration } from './shared/utils';

const ToneChangerTool: React.FC<AiToolComponentProps> = ({ tool, language, onGenerationComplete }) => {
...
export default ToneChangerTool;
