...
import { AiToolComponentProps, IndustryInputToolProps } from '../../types';
import { Loader } from '../Loader';
import { OutputDisplay } from './shared/OutputDisplay';
import { streamTextGeneration } from './shared/utils';

const IndustryInputTool: React.FC<AiToolComponentProps> = ({ tool, language, onGenerationComplete }) => {
...
export default IndustryInputTool;
